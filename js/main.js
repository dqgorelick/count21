...
var gameplay = function() {
    ...
    } else if ((player.total[0] > dealer.total[0] || player.total[1] > dealer.total[0]) && (player.total[0] > dealer.total[1] || player.total[1] > dealer.total[1])) {
        playerwin = 1;
        console.log("player wins");
    } else {
        playerwin = 3;
...
var player_draw = function() {
    if (player.total[0] <= 21 && game.gameover === 1) {
        draw(player);
        update();
    }
...
var update = function() {
    ...
    if (game.gameover === 1 && game.count_hidden === true) {
        ...
        // console.log('hidden: ' + face(dealer.hand[0]));
